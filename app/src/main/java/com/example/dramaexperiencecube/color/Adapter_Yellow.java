...
public class Adapter_Yellow extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public Adapter_Yellow(String[] foodInfoArrayList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_view_row_yellow, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        myViewHolder.item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    Yellow.View_video(myViewHolder.item);
