...
public class Adapter_Red extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public Adapter_Red(String[] foodInfoArrayList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_view_row_red, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        myViewHolder.item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    Red.View_video(myViewHolder.item);
